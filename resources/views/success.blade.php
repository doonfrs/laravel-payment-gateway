...
@section('content')
    @php
        $isOffline = $paymentOrder->paymentMethod
            && $paymentOrder->paymentMethod->plugin_class === \Trinavo\PaymentGateway\Plugins\Offline\OfflinePaymentPlugin::class;
    ...
    <div class="container mx-auto max-w-lg px-4 py-6 md:py-10">
        ...
        @if ($isOffline)
            <!-- Ok Button - Desktop (for offline payments) -->
    ...
    @if ($isOffline)
        <!-- Ok Button - Mobile (sticky footer for offline payments) -->
