...
@section('title', __('sofizpay_payment_error'))
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-red-600 to-red-800 text-white px-6 py-4">
                    <h1 class="text-2xl font-bold">{{ __('sofizpay_payment_error') }}</h1>
                    <p class="text-red-100 mt-1">{{ __('sofizpay_payment_failed_message') }}</p>
                </div>
                <div class="p-6">
                    <div class="mb-6">
