                ...
                <div class="p-6">
                    ...
                    <div class="text-center">
                        ...
                        <div class="grid md:grid-cols-3 gap-6 mb-8">
                            <!-- Direct Success -->
                            <div
                                class="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6 hover:shadow-lg transition-all duration-300">
                                <div class="text-center">
                                    <div
                            ...
                            <!-- Direct Failure -->
                            <div
                                class="bg-gradient-to-br from-red-50 to-rose-50 border border-red-200 rounded-lg p-6 hover:shadow-lg transition-all duration-300">
                                <div class="text-center">
                                    <div
                            ...
                            <!-- External Callback -->
                            <div
                                class="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 hover:shadow-lg transition-all duration-300">
                                <div class="text-center">
                                    <div
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-8">
                            ...
                            <div class="flex flex-wrap justify-center gap-4">
                                <form method="POST" action="{{ $callbackUrl }}" class="inline-block">
                                    ...
                                    <button type="submit"
                                        class="inline-flex items-center px-4 py-2 bg-green-100 text-green-800 border border-green-300 rounded-lg hover:bg-green-200 transition-colors duration-200">
                                ...
                                <form method="POST" action="{{ $callbackUrl }}" class="inline-block">
                                    ...
                                    <input type="hidden" name="order_code" value="{{ $paymentOrder->order_code }}">
                                    <button type="submit"
                                        class="inline-flex items-center px-4 py-2 bg-red-100 text-red-800 border border-red-300 rounded-lg hover:bg-red-200 transition-colors duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M6 18L18 6M6 6l12 12"></path>
